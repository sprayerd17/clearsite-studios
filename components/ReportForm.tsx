...
export default function ReportForm() {
  ...
  const inputClass =
    'w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white placeholder-white/30 focus:outline-none focus:border-[#7B5EA7] transition-colors text-sm';
    ...
    return (
      <div className="text-center py-16 px-4">
        ...
        <p className="text-white/30 text-xs">
          ...
          <a href="/" className="text-[#7B5EA7] hover:underline">
        ...
        <div className="space-y-5">
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-2">
              {['Word of mouth', 'Social media', 'Google search', 'Walk-ins', 'Flyers / print', 'Referrals', 'I\'m not sure'].map(opt => (
                <button
                  key={opt}
                  onClick={() => updateField('howCustomersFind', opt)}
                  className={`px-3 py-2 rounded-lg text-xs font-medium transition-all border ${
                    formData.howCustomersFind === opt
                      ? 'bg-[#7B5EA7] border-[#7B5EA7] text-white'
          ...
          <div className="flex gap-3">
            <button
              onClick={() => setStep(1)}
              className="flex-1 py-3.5 rounded-xl border border-white/10 text-white/60 text-sm font-medium hover:border-white/20 transition-colors"
            >
              ← Back
            </button>
            <button
        ...
        <div className="space-y-5">
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="Any extra context about your business or situation..."
