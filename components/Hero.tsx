  ...
  return (
    <section className="relative overflow-hidden bg-[#1e1b4b] text-white">
      ...
      <div className="relative section container-narrow text-center">
        ...
        {/* Brand name */}
        <h1
          className="text-6xl sm:text-7xl md:text-8xl font-extrabold tracking-tight leading-none mb-6 anim-fade-up"
        ...
        {/* Tagline */}
        <p
          className="text-xl text-slate-400 max-w-2xl mx-auto mb-4 leading-relaxed anim-fade-up"
          style={{ animationDelay: "200ms" }}
        >
          We build websites that work as hard as you do.
        </p>
        <p
          className="text-base text-slate-500 max-w-xl mx-auto mb-12 leading-relaxed anim-fade-up"
